      ...
      <main className="flex-1 p-6 overflow-auto">
        ...
        {activeTab === 'employees' && (
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4 mb-6">
            <div onClick={() => { setCardFilter(null); }} className={`bg-white rounded-xl p-4 shadow-sm border cursor-pointer transition-all hover:shadow-md ${!cardFilter ? 'border-primary-300 ring-2 ring-primary-100' : 'border-gray-100'}`}><Users className="w-5 h-5 text-primary-500 mb-2" /><p className="text-2xl font-bold text-gray-900">{dynamicStats.total}</p><p className="text-xs text-gray-500">Total</p></div>
            ...
            <div onClick={() => { setCardFilter(cardFilter === 'new_this_month' ? null : 'new_this_month'); }} className={`bg-white rounded-xl p-4 shadow-sm border cursor-pointer transition-all hover:shadow-md ${cardFilter === 'new_this_month' ? 'border-primary-300 ring-2 ring-primary-100' : 'border-gray-100'}`}><UserPlus className="w-5 h-5 text-primary-500 mb-2" /><p className="text-2xl font-bold text-primary-600">{dynamicStats.new_this_month}</p><p className="text-xs text-gray-500">Nouveaux</p></div>
