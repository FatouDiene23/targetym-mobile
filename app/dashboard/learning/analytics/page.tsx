        ...
        <div className="space-y-6">
            ...
            <>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                ...
                <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-xs text-gray-500">Sessions réalisées</p>
                ...
                <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-xs text-gray-500">Consommation budget</p>
              ...
              <div className="grid lg:grid-cols-2 gap-6">
                  ...
                  <div className="h-60">
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={planData.quarterly} barGap={4}>
                        ...
                        <Tooltip formatter={(val, name) => [val, name === 'planned' ? 'Planifiées' : 'Réalisées']} />
                        <Legend formatter={(v) => v === 'planned' ? 'Planifiées' : 'Réalisées'} />
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                  <h3 className="font-semibold text-gray-900 mb-4">Répartition par modalité</h3>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                  <h3 className="font-semibold text-gray-900">Tableau de suivi des plans {planYear}</h3>
                  <span className="text-xs text-gray-500">{planData.plans_tracking.length} plan(s)</span>
                </div>
                {planData.plans_tracking.length === 0 ? (
                  <div className="p-10 text-center text-gray-400 text-sm">
                    Aucun plan de formation pour {planYear}.{' '}
                    ...
                    <table className="w-full text-sm">
                      <thead className="bg-gray-50 text-xs text-gray-500 uppercase">
                        <tr>
                          ...
                          <th className="px-4 py-3 text-center">Budget plafond</th>
                          <th className="px-4 py-3 text-center">Taux de réalisation</th>
                        </tr>
                      </thead>
                          ...
                          <tr key={plan.id} className="hover:bg-gray-50 transition-colors">
                            ...
                            <td className="px-4 py-3 text-center">
                              ...
                              {plan.sessions_cancelled > 0 && (
                                <span className="ml-1 text-red-400 text-xs">({plan.sessions_cancelled} annul.)</span>
                              )}
                            </td>
          ...
          {!planLoading && !planError && !planData && (
            <div className="py-16 text-center text-gray-400 text-sm">
              Sélectionnez un exercice pour voir les données.
            </div>
          )}
        </div>
      )}
