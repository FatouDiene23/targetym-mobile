      ...
      <div className="space-y-6">
        ...
        {myCompleted.length === 0 ? (
          <div className="bg-white rounded-xl p-12 text-center">
            ...
            <p className="text-gray-500">Aucune évaluation complétée</p>
            <p className="text-sm text-gray-400 mt-1">Vos résultats apparaîtront ici après validation de vos formations</p>
          </div>
        ) : (
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 mt-0.5">Évalué par {epf.evaluator_name || '—'}</p>
    ...
    <div className="space-y-6">
      ...
      {epfStats && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
            <div className="flex items-center justify-between">
              <div><p className="text-xs text-gray-500">Taux validation</p><p className="text-2xl font-bold text-primary-600">{epfStats.validation_rate}%</p></div>
