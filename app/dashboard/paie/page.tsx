      ...
      <div className="max-w-3xl mx-auto px-4 py-10 space-y-8">
          ...
          {loadingRun ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-xs text-gray-400">{t.payroll.period}</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-xs text-gray-400">{t.payroll.netPayroll}</p>
                  <p className="font-semibold text-gray-800">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-xs text-gray-400">{t.payroll.processedEmployees}</p>
                  <p className="font-semibold text-gray-800">
        ...
        <div className="text-center">
          ...
          >
            ...
            {redirecting ? t.payroll.connecting : t.payroll.accessPayroll}
          </button>
          <p className="mt-2 text-xs text-gray-400">
            {t.payroll.redirectNote} <span className="font-mono">paie.targetym.ai</span>
          </p>
        </div>
      </div>
    </div>
