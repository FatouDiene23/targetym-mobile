...
export default function ObjectivesPage() {
  ...
  return (
    <>
      <Header title={t.performance.objectivesTitle} subtitle={t.performance.objectivesSubtitle} />
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-semibold text-gray-900">{t.performance.okrObjectives}</h3>
              <p className="text-sm text-gray-500">{t.performance.manageOkr}</p>
            </div>
          </div>
        ...
        {stats && (
          <div className="mt-6 p-6 bg-gradient-to-r from-orange-50 to-yellow-50 rounded-xl border border-orange-100">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">{t.performance.okrAchievementRate}</p>
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <p className="text-sm text-blue-800">
            <strong>{t.performance.tip} :</strong> {t.performance.smartTip}
          </p>
        </div>
      </div>
      </main>
