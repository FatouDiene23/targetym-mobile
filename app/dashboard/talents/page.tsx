    ...
    <>
      ...
      <main className="flex-1 p-6 overflow-auto bg-gray-50">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 mb-6" data-tour="talent-stats">
          ...
          <StatCard icon={AlertTriangle} label="À Risque" value={d?.at_risk || 0} color="red" />
          <StatCard icon={ArrowUpRight} label="Éligibles Promotion" value={d?.eligible_promotions || 0} color="purple" />
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-semibold text-gray-900">Parcours de Carrière</h3>
            </div>
            <div className="space-y-3">
              <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                <span className="text-sm text-gray-600">Parcours actifs</span>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                <span className="text-sm text-gray-600">Plans total</span>
                <span className="font-bold text-gray-900">{d?.succession_plans || 0}</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-red-50 rounded-lg">
                <span className="text-sm text-red-700">Postes critiques</span>
                <span className="font-bold text-red-700">{d?.critical_positions || 0}</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-orange-50 rounded-lg">
                <span className="text-sm text-orange-700">Sans successeur</span>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6" data-tour="ninebox-chart">
            ...
            {d?.ninebox_distribution && Object.keys(d.ninebox_distribution).length > 0 ? (
              ...
              <p className="text-sm text-gray-400 text-center py-6">Aucune donnée 9-Box</p>
            )}
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-semibold text-gray-900">Top Talents</h3>
            ...
            <div className="space-y-3">
              {d?.top_talents && d.top_talents.length > 0 ? d.top_talents.map((t: any) => (
                ...
                <p className="text-sm text-gray-400 text-center py-4">Aucun top talent identifié</p>
              )}
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-semibold text-gray-900">Promotions Récentes</h3>
            </div>
            <div className="space-y-3">
              {d?.recent_promotions && d.recent_promotions.length > 0 ? d.recent_promotions.map((p: any, i: number) => (
                ...
                <p className="text-sm text-gray-400 text-center py-4">Aucune promotion récente</p>
              )}
            </div>
          </div>
        </div>
