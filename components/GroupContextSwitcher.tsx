 ...
 */
export default function GroupContextSwitcher({ hideGlobalOption = false }: { hideGlobalOption?: boolean }) {
        ...
        {open && (
          <>
            ...
            <div className="absolute top-full left-0 mt-1 min-w-[260px] bg-white rounded-xl shadow-xl border border-gray-200 z-20 overflow-hidden">
              ...
              {/* Option : Dashboard global du groupe (masqué en gestion du personnel) */}
              {!hideGlobalOption && (
              <button
