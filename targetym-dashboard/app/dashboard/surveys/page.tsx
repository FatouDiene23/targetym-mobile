      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
        <div className="flex items-center gap-4 flex-wrap">
          ...
          <select value={filterType} onChange={e => { setFilterType(e.target.value); setPage(1); }} className="px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary-500">
            ...
            <option value="pulse">{t.surveys.flashSurvey}</option>
            <option value="moments_cles">{t.surveys.keyMoments}</option>
            <option value="thematique">{t.surveys.thematic}</option>
            <option value="annuelle">{t.surveys.annualSurvey}</option>
            <option value="feedback_managerial">{t.surveys.managerialFeedback}</option>
          </select>
          <select value={filterStatus} onChange={e => { setFilterStatus(e.target.value); setPage(1); }} className="px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary-500">
            ...
            <option value="brouillon">{t.surveys.draft}</option>
            <option value="active">{t.surveys.activeSurvey}</option>
            <option value="cloturee">{t.surveys.closed}</option>
            <option value="archivee">{t.surveys.archivedSurvey}</option>
          </select>
        </div>
      </div>
