...
import { Building2, Mail, Lock, User, Phone, Briefcase, Eye, EyeOff, AlertCircle, CheckCircle, ArrowLeft } from 'lucide-react';
        ...
        <div className="w-full max-w-md text-center">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
            ...
            <p className="text-gray-600 mb-6">
              Votre compte est en cours de validation. Vous serez contacté sous <strong>24H</strong>.
            </p>
            <a
