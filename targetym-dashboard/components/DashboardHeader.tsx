...
export default function DashboardHeader({ title, subtitle, showSearch = true, actions }: DashboardHeaderProps) {
  ...
  const [notifications] = useState([
    { id: 1, text: t.notifications.newCandidature, time: t.notifications.ago5min },
    { id: 2, text: t.notifications.objectiveReached, time: t.notifications.ago1h },
    { id: 3, text: t.notifications.performanceReview, time: t.notifications.ago2h },
  ]);
      ...
      <div className="flex items-center space-x-4">
        {showSearch && (
          <div className="relative">
            ...
            <input
              type="text"
              placeholder={t.components.dashboardHeader.searchPlaceholder}
          ...
          {showNotifications && (
            <div className="absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-lg border border-gray-200 z-50">
              <div className="p-4 border-b border-gray-100">
                <h3 className="font-semibold text-gray-900">{t.components.dashboardHeader.notifications}</h3>
              </div>
              ...
              <div className="p-3 text-center border-t border-gray-100">
                <button className="text-sm text-primary-600 hover:text-primary-700 font-medium">
                  {t.components.dashboardHeader.seeAll}
                </button>
              </div>
            </div>
          )}
