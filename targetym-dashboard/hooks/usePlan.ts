...
export const FEATURE_BUDGET_RH = 'budget_rh';           // Budget RH — inclus nativement dans le plan Entreprise
...
const ENTREPRISE_FEATURES = new Set([
  ...
  FEATURE_CHATBOT_ADVANCED, FEATURE_CERTIFICATIONS_RH, FEATURE_BUDGET_RH,
